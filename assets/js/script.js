 ...
 * @param elem
 */
function create_option(selector, elem) {
  var x = document.getElementById("".concat(selector));
...
var INPUT_SEARCH_LOCATION = document.getElementById('js-search-location');
var SELECT_RESULT = document.getElementById("result");
var WEATHER_ICON = document.querySelector(".js-current-icon");
var WEATHER_REQUEST_FORM = document.querySelector(".js-weather-request-form");
var LOCATION = document.querySelector(".js-location-country");
var TEMPERATURE = document.querySelector(".js-current-temp");
var WIND = document.querySelector(".js-current-wind");
var PRECIP = document.querySelector(".js-current-precip");
var PRESSURE = document.querySelector(".js-current-pressure");
var GRADUS = document.querySelector(".js-temp-gradus");
var DESCRIPTION_WEATHER = document.querySelector(".js-description-inner");
var CURRENT_DATA = document.querySelector(".js-current-date");
var FUTURE_DATA = document.querySelectorAll(".js-future-date");
var FUTURE_ICON = document.querySelectorAll(".js-future-icon");
var FUTURE_TEMP = document.querySelectorAll(".js-future-temp");
var FUTURE_GRADUS = document.querySelectorAll(".js-future-gradus");
var ukraineCity = [];
var lat;
var lon;
var api_key = "";
              ...
              response.json().then(function (data) {
                for (var i = 0; i < data.length; i++) {
                  if (data[i].country === "UA") {
                    ...
                    (0, _helpers.create_option)('result', data[i].name);
                  }
                }
              });
            });
...
INPUT_SEARCH_LOCATION && INPUT_SEARCH_LOCATION.addEventListener('input', function (event) {
  event.preventDefault();
  var filter, allOptions;
...
SELECT_RESULT.addEventListener('change', function (event) {
  event.preventDefault(); //console.log('ok');

  var tex = SELECT_RESULT.options[SELECT_RESULT.selectedIndex].text; //console.log('text', tex);
...
var getCurrentTimeFromStamp = function getCurrentTimeFromStamp(timestamp) {
...
WEATHER_REQUEST_FORM && WEATHER_REQUEST_FORM.addEventListener('submit', function (event) {
  event.preventDefault();
  SELECT_RESULT.classList.remove('active');
  var newLocation = event.target.querySelector('#js-search-location').value;
...
},{"./helpers":1,"@babel/runtime/helpers/asyncToGenerator":3,"@babel/runtime/helpers/interopRequireDefault":4,"@babel/runtime/regenerator":5}],3:[function(require,module,exports){
